# ==============================================================================
# LLM Classification Fine-tuning Baseline - LOCAL VERSION
# Competition: https://www.kaggle.com/competitions/llm-classification-finetuning
#
# INSTRUCTIONS FOR LOCAL:
# 1. Ensure models/distilbert-base-uncased/ exists (run download_model.py first)
# 2. Ensure data/ directory contains train.csv, test.csv, sample_submission.csv
# 3. Run this script: python baseline_local.py
# 4. After testing, copy baseline.py to Kaggle notebook for submission
# ==============================================================================
...
class Config:
    ...
    MODEL_NAME = os.path.join(BASE_DIR, "models/distilbert-base-uncased")
